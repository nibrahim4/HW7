...
public class MyTripAdapter extends ArrayAdapter<Trip> {
    ...
    public MyTripAdapter(@NonNull Context context, int resource, @NonNull List<Trip> trips) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView tv_title_trips = convertView.findViewById(R.id.tv_title_mytrip);
        tv_title_trips.setText(trip.getTitle());

        TextView tv_description_trips = convertView.findViewById(R.id.tv_description_mytrip);
        tv_description_trips.setText(trip.getDescription());

        TextView tv_date_trips = convertView.findViewById(R.id.tv_date_mytrip);
        tv_date_trips.setText(trip.get_date());

        TextView tv_location_trip = convertView.findViewById(R.id.tv_address_mytrip);
        tv_location_trip.setText(trip._city);

        ImageView iv_coverPhoto_trips = convertView.findViewById(R.id.iv_coverPhoto_mytrip);
